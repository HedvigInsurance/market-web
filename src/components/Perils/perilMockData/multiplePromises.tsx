...
export const mockPerils: PerilsCollection[] = [
  {
    id: 'SE_APARTMENT_BRF',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        title: 'Water leaks',
        info:
          'Make sure that faucets are sealed and turned off when not in use. Place drip trays that collect water below the fridge/freezer/washing machine. Make sure that the piping system and devices connected to it do not freeze. ',
        covered: [
          'Unexpected escape of liquid/steam from the pipework system, connected appliances or kitchen, laundry room and bathroom',
          'Leaking fridge / freezer',
          'Leaking sink',
      ...
      },
      {
        ...
        icon: {
          variants: {
            dark: {
              svgUrl:
                'https://promise.hedvig.com/media/nature_damage_dark_46d183232e.svg',
            },
            light: {
              svgUrl:
                'https://promise.hedvig.com/media/nature_damage_7fcf39fd3a.svg',
            },
          },
        },
      },
      ...
      },
      {
        ...
        icon: {
          variants: {
            dark: {
              svgUrl:
                'https://promise.hedvig.com/media/pest_sanitation_dark_cb22c7c23b.svg',
            },
            light: {
              svgUrl:
                'https://promise.hedvig.com/media/pest_sanitation_d37cc7358f.svg',
            },
          },
        },
      },
      {
        ...
        icon: {
          variants: {
            dark: {
              svgUrl:
                'https://promise.hedvig.com/media/renovation_dark_f06bdf5e59.svg',
            },
            light: {
              svgUrl:
                'https://promise.hedvig.com/media/renovation_f05a666a9e.svg',
            },
          },
        },
      },
      ...
      },
      {
        title: 'Travel illness',
        info:
          'Always contact us directly through our app or by calling Hedvig Global Assistance(SOS International)  on +45 38 48 94 61.',
        covered: [
          'Casualty, acute illness, acute dental issues',
          'Cancelled travel due to a closely related person dying / becoming seriously ill or injured',
